...
export default class Client extends EventEmitter {
  ...
  constructor(options = {}) {
    ...
    this.connection.on("ChannelRemove", (data: any) => channelRemove.handle(data))
    this.connection.on("ChannelState", (data: any) => channelState.handle(data))
   ...
   * @return {Promise<any>}
   */
  setupVoiceTarget(targetId: number, userIds: Array<number>, channelId: number) {
