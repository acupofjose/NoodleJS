...
const Channel = require("../dist/structures/Channel").default;
const ChannelRemove = require("../dist/handlers/ChannelRemove").default;
...
describe("TextMessage", () => {
    it("should send a textmessage to current channel", () => {
        return client.sendMessage("This is a test message").then((message) => {
